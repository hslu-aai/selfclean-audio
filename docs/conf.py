...
import selfclean_audio

# -- General configuration ------------------------------------------------

# General information about the project.
project = "selfclean-audio"

# The full version, including alpha/beta/rc tags.
release = selfclean_audio.__version__
...
nitpick_ignore = [
    ...
    ("py:meth", "OmegaConf.save"),
    ("py:obj", "selfclean_audio.datasets.audioset20k.AudioSet20K"),
    ("py:obj", "selfclean_audio.datasets.esc50.ESC50"),
    ("py:obj", "selfclean_audio.datasets.folder.FolderAudioDataset"),
    ("py:obj", "selfclean_audio.datasets.musan.MUSANDataset"),
    ("py:obj", "selfclean_audio.datasets.noisy.NoisyDataset"),
    ("py:obj", "selfclean_audio.ssl_adapt.ProjectionHead"),
]
...
intersphinx_mapping = {
    ...
    "omegaconf": ("https://omegaconf.readthedocs.io/en/2.3_branch/", None),
}
...
github_repo = "selfclean-audio"
github_user = "hslu-aai"
